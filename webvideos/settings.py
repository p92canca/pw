"""
Django settings for webvideos project.
...
SECRET_KEY = '*6pym(8ee58dg!2%%_&*mbz81vcha)7v@=^8%0-+jr*^kt5+iy'
...
WSGI_APPLICATION = 'webvideos.wsgi.application'
